...
#德助效果
#【德助】内政，太守锁定技。每年3/6/9/12月初始，若本城民忠＞＝50，概率触发民众资助事件，民忠越高，效果越好。\n（括号内不写进游戏内：情况1，获得10～50米。情况2，获得10～50金。情况3，遇见铁匠，可以把装备库的1～4级武器或者1～4级防具，提高1个档次，锤子的话，先不考虑。情况4，获得1个宝。民忠50～74，触发1和2；民忠75～89触发1～3，民忠90～100，触发1～4）。
