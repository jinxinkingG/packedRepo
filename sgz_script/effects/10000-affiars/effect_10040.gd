...
#重铸主动技
#【重铸】内政，主动技。你可以将装备库中的武器重铸，作为农具发放给民众，提高农业值，每月限3次（括号内不写进游戏内：1级武器＝提高3点。2级武器＝提高6点。3级武器＝提高12点。4级武器＝提高18点，5级武器＝提高25点）。
#（括号内不写进游戏内：1级武器＝提高3点。2级武器＝提高6点。3级武器＝提高12点。4级武器＝提高18点，5级武器＝提高25点）

const EFFECT_ID = 10040
...
const DEV_MAX = 999
const EQUIP_TYPE = "武器"
const REGEN_TARGET = "农具"
const HELP_TARGET = "农户"
