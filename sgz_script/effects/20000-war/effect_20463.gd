...
#增甲主动技 #解锁技能
#【增甲】大战场，主动技。你可以消耗20[备]，指定一个你方武将，直到下回合之前，该武将一次性临时获得隐藏技能<轻甲>。每回合，你至多发动3次，同一个对象不可叠加多次。☆制作组幽科南提醒：本技能发动，需要前置技能<备战>

const EFFECT_ID = 20463
...
const TARGET_SKILL = "轻甲"

# 发动主动技
func effect_20463_start():
