...
# 将计锁定技 #计伤
#【将计】大战场，锁定技。敌方武将使用计策失败时，你对之结算一次“火计”伤害。同一回合，每名敌将至多触发1次。

const EFFECT_ID = 20629
...
func effect_20629_AI_start():
	goto_step("start")
	return

func effect_20629_start():
...
func _get_target_key()->String:
	return "技能.将计.目标.{0}".format([actorId])
