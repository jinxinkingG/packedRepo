...
const COST_RICE_RATE = 5  # 消耗米粮比例
const COST_CD = 3         # 技能冷却回合数
...
func effect_20398_confirm() -> void:
	var wv = me.war_vstate()
	var cost = int(wv.rice * COST_RICE_RATE / 100)
	...
	ske.append_message("获得速进效果", actorId)
