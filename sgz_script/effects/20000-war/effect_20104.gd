...
#离火主动技 #道术
#【离火】大战场，主动技。①你可以消耗8机动力，指定6格内一个对方武将，你对目标周围2格距离内的所有非城地形敌人造成道术离火伤害，该范围内每有一个敌人，你的机动力+1。注：伤兵量＝A*（30～35）/10。其中A＝用计者“德”-受计者“德”，且最小为5。每个回合限1次。②你为张鲁，则额外附加<火神>。

const EFFECT_ID = 20104
...
func effect_20104_AI_2():
	_perform_skill(true, 3001)
	return

func effect_20104_AI_3():
	var se = DataManager.get_current_stratagem_execution()
	report_stratagem_result_message(se, 3001)
	return

func effect_20104_start():
	var se = DataManager.new_stratagem_execution(me.actorId, STRATAGEM)
